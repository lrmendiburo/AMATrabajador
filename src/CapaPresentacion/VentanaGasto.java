 ...
 * @author lrmendiburo
 */
public class VentanaGasto extends javax.swing.JFrame {

    /**
     * Creates new form VentanaGasto
     */
    public VentanaGasto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableCR09.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Monto", "Mes", "Fecha", "Nota", "Oficina"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
            };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaGasto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaGasto().setVisible(true);
            }
        });
    }
