 ...
 * @author lrmendiburo
 */
public class VentanaOfimatica extends javax.swing.JFrame {

    /**
     * Creates new form VentanaOfimatica
     */
    public VentanaOfimatica() {
        initComponents();
    }
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        ventanaAdicionarIngreso.ofimatica();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaOfimatica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaOfimatica().setVisible(true);
            }
        });
    }
