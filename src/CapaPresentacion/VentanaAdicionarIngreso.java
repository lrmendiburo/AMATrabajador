 ...
 * @author lrmendiburo
 */
public class VentanaAdicionarIngreso extends javax.swing.JFrame {

    /**
     * Creates new form VentanaAdicionarDJ08
     */
    public VentanaAdicionarIngreso() {
        initComponents();
    }
    ...
    public void dj05() {
        jComboBoxConcepto.setSelectedIndex(2);
    }

    public void tramite() {
        jComboBoxConcepto.setSelectedIndex(3);
    }

    public void ofimatica() {
        jComboBoxConcepto.setSelectedIndex(4);
    }

    public void otro() {
        jComboBoxConcepto.setSelectedIndex(5);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adicionar Ingreso:");

        jComboBoxConcepto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DJ08", "CR09", "DJ05", "Trámite", "Ofimática", "Otro" }));
        jComboBoxConcepto.setEnabled(false);
        jComboBoxConcepto.setOpaque(false);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jComboBoxConcepto, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(jSpinnerMonto, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        String concepto = jComboBoxConcepto.getSelectedItem().toString();
        float monto = (float) (jSpinnerMonto.getValue());
        String mes = jComboBoxMes.getSelectedItem().toString();
        String fecha = jSpinnerDate.getValue().toString();
        String nota = jTextAreaNota.getText();
        String oficina = jComboBoxOficina.getSelectedItem().toString();
        int idOf=-1;
        ArrayList<Oficina> listaO=Oficina.buscarXNombre(oficina);
        if(!listaO.isEmpty()){
            idOf=listaO.get(0).getId_Oficina();
        }       
        Ingreso ingreso=new Ingreso(concepto, monto, mes, fecha, nota, idOf);
        Ingreso.insertar(ingreso);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAdicionarIngreso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAdicionarIngreso().setVisible(true);
            }
        });
    }
