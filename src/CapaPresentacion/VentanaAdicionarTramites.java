 ...
 * @author lrmendiburo
 */
public class VentanaAdicionarTramites extends javax.swing.JFrame {

    /**
     * Creates new form VentanaAdicionarTramites
     */
    public VentanaAdicionarTramites() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adicionar Trámite:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAdicionarTramites.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAdicionarTramites().setVisible(true);
            }
        });
    }
