 ...
 * @author lrmendiburo
 */
public class VentanaOtro extends javax.swing.JFrame {

    /**
     * Creates new form VentanaOtro
     */
    public VentanaOtro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaOtro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaOtro().setVisible(true);
            }
        });
    }
